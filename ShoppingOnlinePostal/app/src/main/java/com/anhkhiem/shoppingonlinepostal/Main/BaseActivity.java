...
import com.anhkhiem.shoppingonlinepostal.Login.Activiti.LoginActivity;
...
public class BaseActivity extends AppCompatActivity {
    ...
    void initMenu(){
        ...
        PermissionUserUtil.with(this).checkPermission(new PermissionUserUtil.IPermissionUser() {
            ...
            @Override
            public void manager() {
                if (SaveCache.getInstance(BaseActivity.this).getUser().getIDstore()==null){
                    lstIconMenu.add(new MenuIcons(MenuIcons.TypeMenu.ADDSTORE,R.drawable.common_google_signin_btn_icon_dark,"Thêm Cửa Hàng Mới"));
                } else {
                    lstIconMenu.add(new MenuIcons(MenuIcons.TypeMenu.MYSTORE,R.drawable.common_google_signin_btn_icon_dark_focused,"Cửa Hàng Của Tôi"));
                }
            }
